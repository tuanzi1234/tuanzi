<template>
  <div style="width: 70%; margin: 20px auto;">
    <div style="font-size: 20px;" class="card">我的点赞记录：{{ data.total }}</div>
          ...
          <div class="front_card">
            ...
            <div style="padding: 10px;">
              <div style="display: flex; justify-content: space-between;">
                ...
                <div>
                  <el-button type="danger" plain size="small" @click="del(item.id)">取消</el-button>
                </div>
              </div>
    ...
    <div class="card" v-if="data.total">
      <el-pagination @current-change="loadPraise" background layout="total, prev, pager, next"
...
//删除点赞记录的函数
const del = (id) => {
  request.delete('/praise/delete/' + id).then(res => {
    if (res.code === '200') {
