<template>
  ...
  <div class="main-content" style="width: 70%; margin: 20px auto; ">
    ...
    <div
      style="margin-top: 20px; width: 100px; height: 40px; line-height: 40px; padding-left: 10px; font-size: 18px; border-left: 5px solid #008B8B; background: linear-gradient(to right, #00CDCD, white); ">
      热门菜品</div>
